...
<html lang="en">
  <head>
    ...
    <title>Actualizar Instituto</title>
  </head>
  ...
  <body>
    ...
    <div class="container vue" id="contenedor_de_la_forma">
      ...
      <form id="institutoForm" onsubmit="actualizarInstituto(event)">
    ...
    <?php
      require_once('recursos/js/admin/institutos/instituto_actualizar.php');
    ?>
  </body>
</html>

...
<html lang="en">
  ...
  <body>
    <div class="container vue" id="contenedor_de_la_forma">
      ...
      <form id="institutoForm" onsubmit="agregarInstituto(event)">

        <div class="form-group">
          <strong><label for="nombre">Nombre</label></strong>

          <input type="text" class="form-control"
                 id="text-nombreInstituto"
                 name="instituto"
                 placeholder='Escribe un nombre para el instituto'
                 maxlength="45" required>
        </div>

        <a class="btn btn-danger"
            href="<?php echo base_url();?>admin/institutos">
            Cancelar
        </a>

        <input type="submit"
              class="btn btn-success"
              value="Agregar Instituto">
    ...
    <?php
      require_once('recursos/js/admin/institutos/instituto_nuevo.php');
    ?>
  </body>
</html>

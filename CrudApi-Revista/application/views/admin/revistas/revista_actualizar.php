...
<html lang="en">
  ...
  <body>
    <div class="container vue" id="contenedor_de_la_forma">
      ...
      <form onsubmit="actualizarRevista(event)" enctype="multipart/form-data">
          ...
          <div class="form-group">
              <strong><label for="comite para revista">Indice para la revista</label></strong>
          ...
          <input type="submit" class="btn btn-success" value="Actualizar Revista">
      </form>
    ...
    <?php
      require_once('recursos/js/admin/revistas/revista_actualizar.php');
    ?>
  </body>
</html>

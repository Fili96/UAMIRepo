...
<html lang="en">
  ...
  <body>
    <div class="container vue" id="contenedor_de_la_forma">
      ...
      <form id="comiteForm" onsubmit="actualizarComite(event)">
    ...
    <?php
      require_once('recursos/js/admin/comites/comite_actualizar.php');
    ?>
  </body>
</html>

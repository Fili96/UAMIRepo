...
<html lang="en">
  ...
  <body>
    ...
    <div class="container vue" id="contenedor_de_la_forma">
      ...
      <form id="indiceForm" onsubmit="actualizarIndice(event)">
    ...
    <?php
      require_once('recursos/js/admin/indices/indice_actualizar.php');
    ?>
  </body>
</html>

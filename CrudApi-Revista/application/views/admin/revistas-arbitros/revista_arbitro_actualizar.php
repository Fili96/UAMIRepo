...
<html lang="en">
  <head>
    ...
    <title>Actualizar Revista-Arbitro</title>
  </head>
  ...
  <body>
    <div class="container vue" id="contenedor_de_la_forma">
      <h2>Actualizar Revista-Arbitro</h2>
      ...
      <div class="alert alert-danger" v-if='status == "error"'>
        <strong>ERROR: </strong>No se pudo Actualizar, Los datos ya existen
      </div>

      <form id="institutoForm" onsubmit="ActualizarRevistaAutor(event)">
    ...
    <?php
      require_once('recursos/js/admin/revistas-arbitros/revista_arbitro_actualizar.php');
    ?>
  </body>
</html>
